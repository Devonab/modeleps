...
class Ps_FeaturedProducts3 extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'ps_featuredproducts3';
        ...
        $this->displayName = $this->trans('Promotions', array(), 'Promotions');
        $this->description = $this->trans('Displays featured products in the central column of your homepage.', array(), 'Les tendances');

        $this->templateFile = 'module:ps_featuredproducts3/views/templates/hook/ps_featuredproducts.tpl';
    }
    ...
    public function install()
    {
        ...
        Configuration::updateValue('HOME_FEATURED_NBR3', 1);
        Configuration::updateValue('HOME_FEATURED_CAT3', 18);
        Configuration::updateValue('HOME_FEATURED_RANDOMIZE3', true);
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitHomeFeatured')) {
            $nbr = Tools::getValue('HOME_FEATURED_NBR3');
            ...
            $cat = Tools::getValue('HOME_FEATURED_CAT3');
            ...
            $rand = Tools::getValue('HOME_FEATURED_RANDOMIZE3');
            ...
            if (isset($errors) && count($errors)) {
                ...
                Configuration::updateValue('HOME_FEATURED_NBR3', (int) $nbr);
                Configuration::updateValue('HOME_FEATURED_CAT3', (int) $cat);
                Configuration::updateValue('HOME_FEATURED_RANDOMIZE3', (bool) $rand);
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('ps_featuredproducts3'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('ps_featuredproducts3'));
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if (!empty($products)) {
            return array(
                'products' => $products,
                'allProductsLink' => Context::getContext()->link->getCategoryLink($this->getConfigFieldsValues()['HOME_FEATURED_CAT3']),
            );
        }
        return false;
    }
    ...
    {
        $category = new Category((int) Configuration::get('HOME_FEATURED_CAT3'));
        ...
        $nProducts = Configuration::get('HOME_FEATURED_NBR3');
        if ($nProducts < 0) {
            $nProducts = 12;
        }
        ...
        if (Configuration::get('HOME_FEATURED_RANDOMIZE3')) {
