...
* NOTICE OF LICENSE
*
* ARETMIC the Company grants to each customer who buys a virtual
product license to use, and non-exclusive and worldwide. This license is
* valid
...
* the Customer to resell or use on other virtual shops Products
made by ARETMIC. This restriction includes all resources provided with the
* virtual product.
*
* @author    Aretmic SA
...
class ContactControllerCore extends FrontController
{
    ...
    public function canonicalRedirection($canonical_url = '')
    {
        ...
        $alias = '';
        if (!Tools::getValue('noredirect') && (!$idform
        || $idform == 0 || empty($idform))) {
                ...
                if ($fields['fields_type'] == 'captcha') {
                    ...
                    if (!$resp->success) {
                        array_push(
                            $errortxt,
                            $fields['fields_title'].': '.
                            Translate::getModuleTranslation('contactfrm', 'Code not matched', 'contactfrm')
                        );
                        $error++;
                    }
                }
